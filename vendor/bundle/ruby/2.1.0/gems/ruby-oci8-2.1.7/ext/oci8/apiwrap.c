...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static void *oci8_OCILobGetLength_cb(void *user_data)
{
...
sword oci8_OCILobGetLength_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *lenp, const char *file, int line)
{
    if (have_OCILobGetLength_nb) {
        ...
        data.locp = locp;
        data.lenp = lenp;
        oci8_call_without_gvl(svcctx, oci8_OCILobGetLength_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static void *oci8_OCILobRead_cb(void *user_data)
{
...
sword oci8_OCILobRead_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 bufl, dvoid *ctxp, OCICallbackLobRead cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobRead_nb) {
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_call_without_gvl(svcctx, oci8_OCILobRead_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static void *oci8_OCILobTrim_cb(void *user_data)
{
...
sword oci8_OCILobTrim_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 newlen, const char *file, int line)
{
    if (have_OCILobTrim_nb) {
        ...
        data.locp = locp;
        data.newlen = newlen;
        oci8_call_without_gvl(svcctx, oci8_OCILobTrim_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static void *oci8_OCILobWrite_cb(void *user_data)
{
...
sword oci8_OCILobWrite_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 buflen, ub1 piece, dvoid *ctxp, OCICallbackLobWrite cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobWrite_nb) {
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_call_without_gvl(svcctx, oci8_OCILobWrite_cb, &data);
        return data.rv;
    } else {
...
typedef struct {
    ...
    ub4 language;
    ub4 mode;
} oci8_OCIStmtPrepare2_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCIStmtPrepare2_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_9_2
static void *oci8_OCIStmtPrepare2_cb(void *user_data)
{
    oci8_OCIStmtPrepare2_data_t *data = (oci8_OCIStmtPrepare2_data_t *)user_data;
    data->rv = OCIStmtPrepare2(data->svchp, data->stmtp, data->errhp, data->stmt, data->stmt_len, data->key, data->key_len, data->language, data->mode);
...
#else
#define oci8_OCIStmtPrepare2_cb NULL
#endif

sword oci8_OCIStmtPrepare2_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIStmt **stmtp, OCIError *errhp, const OraText *stmt, ub4 stmt_len, const OraText *key, ub4 key_len, ub4 language, ub4 mode, const char *file, int line)
{
    if (have_OCIStmtPrepare2_nb) {
        oci8_OCIStmtPrepare2_data_t data;
        data.svcctx = svcctx;
        data.svchp = svchp;
        data.stmtp = stmtp;
        data.errhp = errhp;
        data.stmt = stmt;
        data.stmt_len = stmt_len;
        data.key = key;
        data.key_len = key_len;
        data.language = language;
        data.mode = mode;
        oci8_call_without_gvl(svcctx, oci8_OCIStmtPrepare2_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIStmtPrepare2_nb");
    }
}
...
static void *oci8_OCIDBShutdown_cb(void *user_data)
{
...
sword oci8_OCIDBShutdown_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode, const char *file, int line)
{
    if (have_OCIDBShutdown_nb) {
        ...
        data.admhp = admhp;
        data.mode = mode;
        oci8_call_without_gvl(svcctx, oci8_OCIDBShutdown_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_2
static void *oci8_OCIDBStartup_cb(void *user_data)
{
...
sword oci8_OCIDBStartup_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode, ub4 flags, const char *file, int line)
{
    if (have_OCIDBStartup_nb) {
        ...
        data.mode = mode;
        data.flags = flags;
        oci8_call_without_gvl(svcctx, oci8_OCIDBStartup_cb, &data);
        return data.rv;
    } else {
