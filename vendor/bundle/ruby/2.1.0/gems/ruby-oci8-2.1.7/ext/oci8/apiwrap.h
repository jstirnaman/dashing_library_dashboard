...
#define OCIStmtPrepare2_nb(svcctx, svchp, stmtp, errhp, stmt, stmt_len, key, key_len, language, mode) \
      oci8_OCIStmtPrepare2_nb(svcctx, svchp, stmtp, errhp, stmt, stmt_len, key, key_len, language, mode, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIStmtPrepare2_nb;
#define have_OCIStmtPrepare2_nb oci8_have_OCIStmtPrepare2_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_9_2
#define have_OCIStmtPrepare2_nb (1)
#else
#define have_OCIStmtPrepare2_nb (0)
#endif
